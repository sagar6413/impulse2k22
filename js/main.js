...
$(window).load(function(){
  var $post_para = $(".post-para"),
      ...
      $pre_para.removeClass("invisible"); $digm.text("pulse");
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Welcome" });$digm.shuffleLetters({ "text": "pulse" });$digm.text("pulse");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "pulse" });$digm.text("pulse");},2000);


   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("pulse");},3000);
});
